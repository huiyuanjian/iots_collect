package com.htby.bksw.logger;

import com.htby.bksw.logger.utils.FastDFSClient;
import com.htby.bksw.logger.utils.FastDFSFile;
...
@Component("uploadLoggerService")
@Slf4j
public class UploadLoggerService {

    public static void main(String[] args) {
        UploadLoggerService service= new UploadLoggerService();
        String url= null;
        try {
    ...
    public String upload(String path) throws IOException {
        ...
        UploadLoggerService uploadService = new UploadLoggerService();
